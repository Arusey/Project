...
var { isLoggedIn, checkUserRestaurant, checkUserComment, isAdmin, isSafe } = middleware; // destructuring assignment

// Define escapeRegex function for search feature
//the regular expression allows the user or search the restaurant through the restaurant name
...
router.post("/", isLoggedIn, isSafe, function(req, res){
  ...
  //links with the google maps API to load the location of the restaurant
  ...
  geocoder.geocode(req.body.location, function (err, data) {
    ...
    var newRestaurant = {name: name, image: image, description: desc, cost: cost, rating: rating, author:author, location: location, lat: lat, lng: lng};
...
router.get("/:id/edit", isLoggedIn, checkUserRestaurant, function(req, res){
  ...
  //render edit template with that restaurants
  res.render("restaurants/edit", {restaurant: foundRestaurant});
});
});

// PUT - updates restaurants in the database
